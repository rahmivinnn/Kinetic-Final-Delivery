...
export default function AppointmentsPage() {
  ...
  const handleJoin = (id: number) => {
    router.push(`/video-call?appointmentId=${id}`)
  }
  ...
  const handleCancel = (id: number) => {
    if (confirm("Are you sure you want to cancel this appointment?")) {
      ...
      // Implementasi: hapus dari state jika ingin real
    }
  }
  const handleScheduleTherapist = (id: number) => {
    router.push(`/appointments/schedule?therapistId=${id}`)
  }
  const handleViewProfile = (id: number) => {
    router.push(`/therapists/${id}`)
  }
  const handleMessageTherapist = (id: number) => {
    router.push(`/messages?therapistId=${id}`)
  }
  const handleViewAllHistory = () => {
    router.push("/appointments/history")
  }
  const handleAddReminder = () => {
    alert("Add new reminder feature coming soon!")
  }
  const handleEditReminder = (id: number) => {
    alert("Edit reminder feature coming soon!")
  }
  const handleDeleteReminder = (id: number) => {
    if (confirm("Delete this reminder?")) {
      alert("Reminder deleted (mock)")
    }
  }
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-8">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <Button className="bg-[#014585] hover:bg-[#013a70]" onClick={handleScheduleNew}>
                    ...
                    <td className="py-4 px-6">
                      <div className="flex space-x-2">
                        {appointment.mode === "Virtual" && appointment.status === "Confirmed" && (
                          <Button variant="outline" size="sm" className="text-blue-600 border-blue-200" onClick={() => handleJoin(appointment.id)}>
                        ...
                        <Button variant="outline" size="sm" className="text-red-600 border-red-200" onClick={() => handleCancel(appointment.id)}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {therapists.map((therapist) => (
              <div key={therapist.id} className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="flex space-x-2">
                  <Button variant="outline" className="flex-1 bg-[#014585] text-white hover:bg-[#013a70]" onClick={() => handleScheduleTherapist(therapist.id)}>
                    Schedule
                  </Button>
                  <Button variant="outline" className="flex-1" onClick={() => handleViewProfile(therapist.id)}>
                    View Profile
                  </Button>
                  <Button variant="outline" className="flex-1" onClick={() => handleMessageTherapist(therapist.id)}>
                    Message
                  </Button>
                </div>
              </div>
          ...
          <div className="space-y-4 mb-8">
                ...
                <div className="pl-14">
                  ...
                  {appointment.followUpRecommended && (
                    <div className="flex items-center justify-between bg-blue-50 p-2 rounded-md">
                      ...
                      <Button size="sm" className="h-7 bg-[#014585] hover:bg-[#013a70]" onClick={handleScheduleNew}>
                        Schedule
                      </Button>
                    </div>
                  )}
            ...
            <div className="flex justify-center mt-4">
              <Button variant="outline" className="text-[#014585]" onClick={handleViewAllHistory}>
                View All History
              </Button>
            </div>
          </div>
          ...
          <div className="space-y-3">
              ...
              <div key={reminder.id} className="bg-white rounded-lg shadow-sm p-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <div className="flex space-x-2">
                      <Button variant="ghost" size="sm" className="h-7 px-2 text-gray-500" onClick={() => handleEditReminder(reminder.id)}>
                        Edit
                      </Button>
                      <Button variant="ghost" size="sm" className="h-7 px-2 text-gray-500" onClick={() => handleDeleteReminder(reminder.id)}>
                        Delete
                      </Button>
                    </div>
                  </div>
            ...
            <div className="mt-4">
              <Button className="w-full bg-[#014585] hover:bg-[#013a70]" onClick={handleAddReminder}>
