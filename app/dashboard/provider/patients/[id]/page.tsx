...
export default function PatientDetailPage({ params }: { params: { id: string } }) {
  ...
  const handleEditPatient = () => {
    router.push(`/dashboard/provider/patients/${patientId}/edit`)
  }
  const handleSchedule = () => {
    router.push(`/appointments/schedule?patientId=${patientId}`)
  }
  const handleMessage = () => {
    router.push(`/messages?patientId=${patientId}`)
  }
  const handleOpenPose = () => {
    router.push(`/pose-estimation?patientId=${patientId}`)
  }
  const handleViewExerciseHistory = () => {
    router.push(`/progress/history?patientId=${patientId}`)
  }
  const handleGenerateReport = () => {
    router.push(`/progress/reports?patientId=${patientId}`)
  }
  const handleUpdatePlan = () => {
    router.push(`/dashboard/provider/patients/${patientId}/edit-plan`)
  }
  const handleVideoConsultation = () => {
    router.push(`/video-call?patientId=${patientId}`)
  }
        ...
        <div className="p-8">
          ...
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="flex space-x-3">
              <Button variant="outline" className="gap-2" onClick={handleEditPatient}>
              ...
              <Button className="bg-[#014585] hover:bg-[#013a70] gap-2" onClick={handleOpenPose}>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        <Button variant="outline" className="w-full justify-between" onClick={handleViewExerciseHistory}>
                          View Exercise History
                          <ArrowRight className="ml-2 h-4 w-4" />
                        </Button>
                        <Button variant="outline" className="w-full justify-between" onClick={handleGenerateReport}>
                          Generate Progress Report
                          <Download className="ml-2 h-4 w-4" />
                        </Button>
                        <Button variant="outline" className="w-full justify-between" onClick={handleUpdatePlan}>
                          Update Treatment Plan
                          <Edit className="ml-2 h-4 w-4" />
                        </Button>
                        <Button variant="outline" className="w-full justify-between" onClick={handleVideoConsultation}>
                          Video Consultation
            ...
            <TabsContent value="appointments">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  ...
                  <Button className="bg-[#014585] hover:bg-[#013a70]" onClick={handleSchedule}>
